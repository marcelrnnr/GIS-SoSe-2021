...
/*
    ...
    let _bildersrc = document.createAttribute("src");
    let _bildindex = document.createAttribute("indexnumber");
    let _bilderid = document.createAttribute("id");
    _bildindex.value = "0";
    _bildersrc.value = "becher.png";
    _bilderid.value = "becher1";
    _bilder.setAttributeNode(_bildindex);
    _bilder.setAttributeNode(_bilderid);
    _bilder.setAttributeNode(_bildersrc);
    ...
    let _bildersrc2 = document.createAttribute("src");
    let _bildindex2 = document.createAttribute("indexnumber");
    let _bilderid2 = document.createAttribute("id");
    _bildindex2.value = "1";
    _bildersrc2.value = "waffel.png";
    _bilderid2.value = "waffel1";

    _bilder2.setAttributeNode(_bildindex2);
    _bilder2.setAttributeNode(_bilderid2);
    _bilder2.setAttributeNode(_bildersrc2);
    ...
    let _bilder3src = document.createAttribute("src");
    let _bilder3id = document.createAttribute("id");
    let _bildindex3 = document.createAttribute("indexnumber");
    _bilder3src.value = "Stiel.png";
    _bildindex3.value = "2";
    _bilder3id.value = "stiel1";


    _bilder3.setAttributeNode(_bildindex3);
    _bilder3.setAttributeNode(_bilder3id);
    _bilder3.setAttributeNode(_bilder3src);
    ...
    document.getElementById("waffel1").addEventListener("click", bilder);
    document.getElementById("becher1").addEventListener("click", bilder);
    document.getElementById("stiel1").addEventListener("click", bilder);


    let behaelterX: Behaelter = null;

    function bilder(_event: Event): void {
        let imagetarget: HTMLImageElement = <HTMLImageElement>_event.target;
        let imagenumber: number = parseInt(imagetarget.getAttribute("indexnumber"));

        behaelterX = alleBehaelter[imagenumber];
